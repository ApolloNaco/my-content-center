package com.itmuch.mycontentcenter.auth;

import com.itmuch.mycontentcenter.util.JwtOperator;
...
public class AuthAspect {
    ...
    @Around("@annotation(com.itmuch.mycontentcenter.auth.CheckLogin)")
    ...
    @Around("@annotation(com.itmuch.mycontentcenter.auth.CheckAuthorization)")
